...
class AdminUpdateRestaurantRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'mall_name' => ['array:en,ar,fr,ur,tr,sw'],

            'mall_name.en' => ['string','max:190'],
            'mall_name.ar' => ['string','max:190'],
            'mall_name.fr' => ['string','max:190'],
            'mall_name.ur' => ['string','max:190'],
            'mall_name.tr' => ['string','max:190'],
            'mall_name.sw' => ['string','max:190'],
